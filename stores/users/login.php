	...
	<div class="col-md-6 p-0 bg-indigo h-md-100">
		<div class="text-white d-md-flex align-items-center h-100 p-5 text-center justify-content-center" style="background-color: #0D0E52;">
			<div class="logoarea pt-5 pb-5">
				...
				-->
				<h1 class="mb-0 mt-3 display-4">User Login</h1>
				<h5 class="mb-4 font-weight-light">Login to your dashboard to manage your orders.</h5>
				<h5 class="mb-4 font-weight-light">Not created an account yet?</h5>
				<a class="btn btn-outline-white btn-lg" href="register">register</a>
				</a>
			</div>
		</div>
	</div>
		...
		<div class="d-md-flex align-items-center h-md-100 justify-content-center">
			<div class="border rounded p-5"><!--was form-->
				...
				<div class="form-group">
					<input type="text" class="form-control" style="width: 100%;" id="email" aria-describedby="emailHelp" placeholder="E-mail Address" required="">
				</div>
				<div class="form-group">
