              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <form action="#" method="post" enctype='multipart/form-data' class="update-details" id="add_media_form" style="display: none;">
                        <div class="form-group">
                                ...
                                <div class='input-group col-xs-12'>
                                    <input type="file" name="file" id="profile-image" class="form-control file-upload-info" accept="image/*">
                                </div>
                                <button class="btn btn-primary me-2" name="add_image"><?php if($store_row['logo'] == ""){echo "Add";}else{echo "Update";} ?>
                                </button>
                        </div>
                    </form><br><br>
                  ...
                  <div class="forms-sample"><!--was form-->
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword4">Delivery Fee <em>(If No delivery Fee, Write free)</em></label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputCity1">Google Pixel Code <em>(Optional)</em></label>
