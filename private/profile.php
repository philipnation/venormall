...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE contact SET email='$email', password='$password', phonenumber='$phonenumber', contact_email='$contact_email', address='$address'";
    $result = mysqli_query($conn, $sql);
    if($result){
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Profile / contact detials</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
