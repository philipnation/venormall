...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sqldel = "DELETE FROM sliding_images WHERE id='$id'";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Sliding images</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">Sliding images</h5>
                                    </div>
                                    <div class="col-7">
                                        <div class="text-end upgrade-btn">
                                            <a href="addimage.php" class="btn btn-danger text-white">add +</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- title -->
                            ...
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM sliding_images";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            <td>$i</td>
                                            <td>
                                                <img class='btn btn-circle d-flex btn-info text-white' style='background: transparent; width:80px;height:80px;border:1px solid transparent' src='../assets/img/$row[image]'>
                                            </td>
                                            <td><a href='images.php?id=$row[id]' style='color:red;'>remove</a></td>
                                        </tr>
                                            ";
                                        }
                                        ?>
