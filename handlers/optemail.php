      ...
      <div style="display: flex;
        ...
        <div class="link-preview">
          ...
          <div style="text-align: center;">
            <h1 class="username">Your OTP is</h1>
            <h3 style="margin:auto;margin-top:50px;text-align: center;">'.$_SESSION['otp'].'</h3>
            <h4>
                For security reasons and in line with our verification protocols, 
                please ensure that the One-Time Password (OTP) received via email is verified on the same device the OTP was delivered to. 
