	...
	<script src="assets/js/ajax.js"></script>
                ...
                $(document).ready(function() {
                  $('#signin').click(function() {
                      var email = $("#email").val();
                      $.post("handlers/getresetlink.php", {
                          email:email
	...
	<div class="col-md-6 p-0 bg-white h-md-100 loginarea">
		<div class="d-md-flex align-items-center h-md-100 justify-content-center">
			<div class="border rounded p-5"><!--was form-->
				...
				<button type="submit" id="signin" class="btn btn-success btn-block shadow-sm" style="background-color: #0D0E52; border: 1px solid #0D0E52;">get reset link</button>
			</div><!--was /form-->
		</div>
	</div>
</div>
